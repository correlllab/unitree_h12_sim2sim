...
from agile.rl_env.assets.robots import unitree_h1_2 as unitree_h12
...
class MySceneCfg(InteractiveSceneCfg):
    ...
    robot = unitree_h12.H1_2_27DOF_DELAYED_DC_MOTOR.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
class RewardsCfg:
    ...
    base_height = RewTerm(
        ...
        weight=2.5,
        params={
            "target_height": unitree_h12.DEFAULT_PELVIS_HEIGHT,
            "std": 0.1,
    ...
    feet_slip = RewTerm(
        ...
        params={
            ...
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=unitree_h12.FEET_LINK_NAMES),
            "robot_cfg": SceneEntityCfg("robot", body_names=unitree_h12.FEET_LINK_NAMES),
        },
    )
    ...
    feet_roll = RewTerm(
        ...
        weight=-0.05,
        params={"asset_cfg": SceneEntityCfg("robot", body_names=unitree_h12.FEET_LINK_NAMES)},
    )
    ...
    feet_yaw_mean = RewTerm(
        ...
        weight=-2.0,
        params={
            "feet_asset_cfg": SceneEntityCfg("robot", body_names=unitree_h12.FEET_LINK_NAMES),
    ...
    feet_distance = RewTerm(
        ...
        weight=-0.1,
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names=unitree_h12.FEET_LINK_NAMES),
            "ref_distance": 0.2,
        },
    )
...
class TerminationsCfg:
    ...
    illegal_base_height = DoneTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names="pelvis"),
            "sensor_cfg": SceneEntityCfg("height_measurement_sensor"),
            "height_threshold": unitree_h12.DEFAULT_PELVIS_HEIGHT - 0.3,
        },
    )
...
@configclass
class H12LowerVelocityHistoryEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the H12 velocity tracking environment."""
