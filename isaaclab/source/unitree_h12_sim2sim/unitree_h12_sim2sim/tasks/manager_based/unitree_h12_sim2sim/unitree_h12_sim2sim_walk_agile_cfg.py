...
from ....robots.unitree_h12_agile import H1_2_27DOF_DELAYED_DC_MOTOR  # isort:skip
...
class H12LocomotionSceneCfg(InteractiveSceneCfg):
    ...
    # robots
    robot: ArticulationCfg = H1_2_27DOF_DELAYED_DC_MOTOR.replace(prim_path="{ENV_REGEX_NS}/Robot")
