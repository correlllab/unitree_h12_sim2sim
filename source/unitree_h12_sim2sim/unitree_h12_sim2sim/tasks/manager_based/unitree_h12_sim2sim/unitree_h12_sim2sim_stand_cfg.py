...
####################################################################
#Robot config
from ....robots.unitree_h12 import H12_CFG_HANDLESS, H12_ACTION_SCALE  # isort:skip
...
class H12StandSceneCfg(InteractiveSceneCfg):
    """Configuration for H12 standing scene."""
...
@configclass
class RewardsStandCfg:
    """Reward terms for standing (simplified)."""
    ...
    # -- posture (keep joints near defaults)
...
class H12StandEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for H12 standing task."""
    ...
    # MDP settings
    rewards: RewardsStandCfg = RewardsStandCfg()
